  ...
  return (
    <div className="p-6 max-w-sm mx-auto bg-white rounded-xl shadow-md flex flex-col items-center"  style={{ height: "220px" }}>
      <div className="w-full text-center">
        ...
        <button className="mt-4 px-4 py-1 bg-green-400 text-white rounded hover:bg-green-600" onClick={onNext}>Avanti</button>
      </div>
    </div>);
}
  ...
  return (
    <div className="p-6 max-w-sm mx-auto bg-white rounded-xl shadow-md flex flex-col items-center"  style={{ height: "220px" }}>
      ...
      <div className="flex space-x-4 mt-4">
        <button className="px-4 py-1 bg-gray-300 text-white rounded hover:bg-gray-500" onClick={onBack}>Indietro</button>
        <button className="px-4 py-1 bg-green-400 text-white rounded hover:bg-green-600" onClick={onNext}>Avanti</button>
      </div>
    </div>
  );
}
