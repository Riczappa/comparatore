...
<footer className="footer text-center p-4 bottom-0 w-full bg-white shadow-md">
    <div className="container mx-auto flex flex-col md:flex-row justify-between items-center">
        ...
        <div className="flex flex-col md:flex-row md:items-center md:space-x-4">
            ...
            <a href="mailto:comparatore@trepdigitalx.com?subject=Richiesta di Contatto&body=Ciao, vorrei saperne di più su..." className="text-gray-600 text-sm hover:underline">Contact us</a>
