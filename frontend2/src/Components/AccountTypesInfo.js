...
function AccountTypesInfo() {
  return (
    <div className="flex flex-col md:flex-row justify-center md:space-x-3 items-center text-center my-8">
      <div className="md:w-1/4 p-4 mt-2 bg-gray-100 rounded-lg">
